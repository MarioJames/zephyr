...
function getSessionList(params?: SessionListRequest) {
  return http.get<SessionItem[]>("/api/v1/sessions/list", params);
}
...
function createSession(data: SessionCreateRequest) {
  return http.post<SessionItem>("/api/v1/sessions/create", data);
}
 ...
 * @returns SessionItem
 */
function updateSession(data: SessionCreateRequest) {
  return http.post<SessionItem>("/api/v1/sessions/update", data);
}
