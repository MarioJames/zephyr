...
import agentService, { AgentItem, CreateAgentRequest, UpdateAgentRequest } from '@/services/agents';
...
export const agentSlice: StateCreator<
  AgentStore,
  [],
  [],
  AgentAction
  ...
  updateAgent: async (id: string, data: UpdateAgentRequest) => {
    ...
    try {
      ...
      set((state) => ({
        ...
        currentAgent: state.currentAgentId === id ? updatedAgent : state.currentAgent,
        isLoading: false,
        error: undefined,
      }));
    } catch (error) {
  ...
  deleteAgent: async (id: string) => {
    ...
    try {
      ...
      set((state) => ({
        ...
        currentAgent: state.currentAgentId === id ? undefined : state.currentAgent,
        currentAgentId: state.currentAgentId === id ? undefined : state.currentAgentId,
        isLoading: false,
        error: undefined,
      }));
    } catch (error) {
