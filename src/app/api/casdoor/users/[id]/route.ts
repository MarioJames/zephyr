...
export async function PUT(
  ...
  try {
    ...
    const updatedUserData = {
      ...existingUser.data,
      displayName: body.displayName || existingUser.data.displayName,
      email: body.email || existingUser.data.email,
      phone: body.phone || existingUser.data.phone,
      avatar: body.avatar !== undefined ? body.avatar : existingUser.data.avatar,
      firstName: body.firstName !== undefined ? body.firstName : existingUser.data.firstName,
      lastName: body.lastName !== undefined ? body.lastName : existingUser.data.lastName,
...
export async function DELETE(
  ...
  try {
    ...
    const result = await sdk.deleteUser(userToDelete);
