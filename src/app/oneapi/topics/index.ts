...
const API = {
   ...
   * @returns TopicItem[]
   */
  getTopicList: (params: TopicListRequest) => http.get<TopicItem[]>("/api/v1/topics/list", params),
   ...
   * @returns TopicItem
   */
  createTopic: (data: TopicCreateRequest) => http.post<TopicItem>("/api/v1/topics/create", data),
   ...
   * @returns TopicItem
   */
  summaryTopic: (topicId: string) => http.post<TopicItem>("/api/v1/topics/summary", { topicId }),
};
