...
const API = {
   ...
   */
  queryTranslate: (params: MessageTranslateQueryRequest) => http.get<MessageTranslateItem>("/api/v1/message_translates/query", params),
   ...
   * @returns void
   */
  triggerTranslate: (data: MessageTranslateTriggerRequest) => http.post<void>("/api/v1/message_translates/translate", data),
};
