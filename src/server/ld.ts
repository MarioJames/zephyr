...
import { DEFAULT_LANG, Locales } from '@/config/translate';
...
export class Ld {
  ...
  genWebSite() {
    const baseInfo: any = {
      '@id': this.getId(OFFICIAL_URL, '#website'),
      '@type': 'WebSite',
      'description': 'LobeChat is a modern design-engineer platform for AIGC, providing design components and tools, fostering knowledge interaction and the exchange of ideas.',
      'inLanguage': DEFAULT_LANG,
      'name': BRANDING_NAME,
      'publisher': {
        '@id': this.getId(OFFICIAL_URL, '#organization'),
